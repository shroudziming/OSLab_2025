...
void sys_yield(void)
{
    ...
    return call_jmptab(SYS_YIELD, IGNORE, IGNORE, IGNORE, IGNORE, IGNORE);
...
void sys_move_cursor(int x, int y)
{
    ...
    return call_jmptab(SYS_MOVE_CURSOR,(long)x,(long)y, IGNORE, IGNORE, IGNORE);
...
void sys_write(char *buff)
{
    ...
    return call_jmptab(SYS_WRITE, (long)buff, IGNORE, IGNORE, IGNORE, IGNORE);
...
void sys_reflush(void)
{
    ...
    return call_jmptab(SYS_REFLUSH, IGNORE, IGNORE, IGNORE, IGNORE, IGNORE);
